...
#include "wadExampleConfigFile.h"

namespace wad
{
    void ExampleConfigFile::SetParameters()
    {
...
//		}        
	...
	void ExampleConfigFile::SetResultsProperties()
	{
        ...
        if( m_debug ) std::cout << "ExampleConfigFile::SetResultsProperties" << std::endl;
