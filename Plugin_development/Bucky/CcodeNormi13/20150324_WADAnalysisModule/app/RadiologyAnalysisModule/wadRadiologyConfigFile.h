...
#ifndef WADRADIOLOGYCONFIGFILE_H
#define WADRADIOLOGYCONFIGFILE_H
...
{
/**
 * \class RadiologyConfigFile
 * \brief Derived class implementing radiology configuration parameters
 *
 */
	class RadiologyConfigFile : public ConfigFile
	{
	public:
